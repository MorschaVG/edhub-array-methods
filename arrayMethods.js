...
// const sweetSixteenth = inventors.filter((cent) =>
//     cent.year >= 1500 && cent.year < 1600);
//
//
// console.log(sweetSixteenth);
//
...
// const fullNames = inventors.map(({first, last}) => {
//     return `${first} ${last}`;
//
// })
...
const edison = inventors.find(inv => inv.last === 'Edison');
console.log(edison);